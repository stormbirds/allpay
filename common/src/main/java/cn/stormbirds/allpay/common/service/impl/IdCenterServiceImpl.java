...
@Service
public class IdCenterServiceImpl implements IdCenterService {

    @Value(value = "${idcenter.datacenterId:1}")
    private long datacenterId ;
    @Value(value = "${idcenter.workerId:1}")
    private long workerId ;
    @Value(value = "${idcenter.desc:这是测试}")
    private String desc ;
